...
class wpcs_Admin {
	...
	function display_options() {
        ...
        <div class="wrap">
			...
			<?php } ?>
            <p>版本 <?php echo wpcs_VERSION; ?>. <a href="https://wenpai.org/" title="文派开源"
                                                    target="_blank">文派开源</a> | <a
                        href="https://wpchinese.cn" target="_blank" title="插件主页">插件主页</a></p>

            <div class="tab">
                <button class="tablinks" onclick="openTab(event, 'Tab1')">基础设置</button>
                <button class="tablinks" onclick="openTab(event, 'Tab2')">高级设置</button>
            </div>
            ...
            <div id="Tab1" class="tabcontent">
                <form id="wpcso_form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>"><input type="hidden"
                    ...
                    <table class="form-table">
                        ...
                        <tr>
                            <td valign="top" width="30%">自定义"不转换"标签名
                                <span class="tooltip">
                    <span class="tooltiptext">本插件输出的widget中将包含当前页面原始版本链接, 您可以在这里自定义其显示的名称. 如果留空则使用默认的"不转换".</span>
                </span>
                            </td>
                            <td><!--wpcs_NC_START-->
                        ...
                        <tr>
                            <td valign="top" width="30%">对下面几种中文开启转换功能
                                <span class="tooltip">
                    <span class="tooltiptext">未选中的中文语言将不被使用,此项设置为全局设置.您应该选中至少一种中文语言,否则本插件全部功能都不会工作.
                  在每个复选框后的文本输入框里可以输入该语言自定义名称, 如果留空会使用默认值. <!--wpcs_NC_START-->("简体中文", "繁体中文"...)
                        <!--wpcs_NC_END--></span>
                            ...
                            <td><!--wpcs_NC_START-->
                                ...
                                <input type="text" placeholder="请输入展示名称(默认值如左)"
                        ...
                        <tr>
                            <td valign="top" width="30%">展示形式
                                <span class="tooltip">
                    <span class="tooltiptext">修改语言切换按钮的展现形式</span>
                </span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td scope="row" valign="top" width="30%">
                                中文搜索关键词简繁转换
                                <span class="tooltip">
                    <span class="tooltiptext">本选项将增强WordPress搜索功能, 使其对中文关键词繁简统一处理.
                  ...
                  (此功能将增加搜索时数据库负担)</span>
                            ...
                            <td>
                                <select id="wpcso_search_conversion" value="" name="wpcso_search_conversion"
                                        style="width: 250px;">
                        ...
                        <tr>
                            <td valign="top" width="30%">识别浏览器中文语言动作
                                <span class="tooltip">
                    <span class="tooltiptext"><b>本项设置不会应用于搜索引擎.</b> 如果本选项设置不为"关闭", 进程将识别访客浏览器首选中文语言.
                  ...
                  假如您在本页第一项设置里禁用了部分中文,如zh-hk, 那幺浏览器里语言设置里只有"<!--wpcs_NC_START--> 港澳繁体
                        <!--wpcs_NC_END--> "的用户访问时默认不会被识别;
                  但如果选中了此复选框,只要您开启了"<!--wpcs_NC_START--> 繁体中文<!--wpcs_NC_END--> ", "
                        <!--wpcs_NC_START--> 台湾正体
                        <!--wpcs_NC_END--> "
                  或 "<!--wpcs_NC_START--> 港澳繁体<!--wpcs_NC_END--> " 中任一种语言, 浏览器使用这三种语言的用户都会被本插件识别并根据选项做出动作.
                  (但此时页面被转换后的语言可能并不是用户浏览器设置的那种, 而是您开启的那种繁体语言). 简体语系同理.</span>
                </span>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td valign="top" width="30%">使用Cookie保存并识别用户语言偏好
                                <span class="tooltip">
                    <span class="tooltiptext"><b>本项设置不会应用于搜索引擎.</b> 如果开启这项设置,本插件将自动保存访客的语言选择.举例而言,
                  ...
                  请把这两项设置均设为"关闭",否则这两个功能不但不会正常工作, 而且可能造成缓存异常.</span>
                        ...
                        <tr>
                            <td valign="top" width="30%">不转换文章中某些HTML标签里中文
                                <span class="tooltip">
                    <span class="tooltiptext">这里输入的HTML标签里内容将不进行中文繁简转换(仅适用文章内容), 保持原样输出. 请输入HTML标签名,
                  如<code>pre</code>;
                  ...
                  <code>.class1,div#para1</code>, <code>table,span.nocc,div[attr="hello"]</code>. 如果遇到html错误, 请关闭此选项.
                            ...
                            <td>
                                <input type="text" value="<?php echo $this->options['wpcs_no_conversion_tag']; ?>"
                                       style="width: 250px;"
                        ...
                        <tr>
                            <td valign="top" width="30%">不转换日语(lang="ja")的HTML标签里内容
                                <span class="tooltip">
                    <span class="tooltiptext">未如果选中此选项, 文章内容中用 lang="ja" 标记为日本语的html tag将不进行繁简转换,
                  保持原样输出.
                  ...
                  如果遇到html错误, 请关闭此选项.</span>
                        ...
                        <tr>
                            <td valign="top" width="30%">不转换HTML中任意内容TAG
                                <span class="tooltip">
                    <span class="tooltiptext"> HTML中所有位于 <code>&lt;!--wpcs_NC_START--&gt;</code> 和 <code>&lt;!--wpcs_NC_END--&gt;</code>之间的内容将不会进行繁简转换,
                  保持原样输出.
                  您可以在模板或post内容中使用这个标签.<br/>您可以选择在WordPress的文章编辑器(html模式)工具栏中插入一个按钮(显示为"wpcs_NC"), 方便快速在文章中插入这个标签.</span>
                </span>
                            </td>
                            <td>
                                ...
                                <label for="wpcso_no_conversion_qtag">在WordPress文章html编辑器中添加"不转换中文"的Quick
                                    tag</label>
                            </td>
                        </tr>

                        <tr>
                            <td valign="top" width="30%">繁简转换页面永久链接格式
                                <span class="tooltip">
                    <span class="tooltiptext">
                        更改此项设置前,<b>请仔细阅读下面的说明:</b><br/>本项设置决定插件生成的繁简转换页面Permalink.
                  ...
                  本项设置只能选择第一种URL形式.
                        ...
                        <tr>
                            <td valign="top" width="30%">对页面内容整体转换
                                <span class="tooltip">
                    <span class="tooltiptext">
            ...
            <div id="Tab2" class="tabcontent">
				...
				?>;">
                    <div style="padding-top: 30px; padding-bottom: 20px; "><b>WP Super Cache兼容
                            <span class="tooltip">
                                <span class="tooltiptext">
                                    默认情况下,
                                        本插件的"识别浏览器中文语言动作"和"使用Cookie保存并识别用户语言偏好"这两个功能与缓存插件不兼容.
                                        如果您使用的是<a href="http://wordpress.org/extend/plugins/wp-super-cache/">WP
                                            Super
                                            Cache</a>的"Legacy page
                                        caching"缓存模式,
                                        您可以点击下面的按钮安装WP Super Cache兼容. <b>注意:
                                            如果您没有开启"识别浏览器中文语言动作"和"使用Cookie保存并识别用户语言偏好"这两个功能(默认均为关闭),
                                            则无需安装此兼容</b>; 安装本兼容将增加WP Super Cache的缓存磁盘空间占用; <b>仅支持WP
                                            Super Cache插件的"Legacy page caching"模式,
                                            不支持"PHP Cache"和"mod_rewrite cache"模式. (WP Super Cache 插件安装后默认为"PHP
                                            Cache"模式,
                                            您必须手动切换到"Legacy"模式.)</b>
                                </span>
                            </span>
                        </b></div>
                ...
                <form id="wpcso_uninstall_form" method="post" action="<?php echo $_SERVER['REQUEST_URI']; ?>">
                    <table class="form-table">
                        <tbody>
                        <tr>
                            <td valign="top" width="30%">确定卸载本插件?
                                <span class="tooltip">
                    <span class="tooltiptext">
                       这将清除数据库options表中本插件的设置项(键值为wpcs_options),
